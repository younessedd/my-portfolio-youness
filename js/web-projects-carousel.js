...
(function() {
    ...
    const WebProjectsCarousel = {
        ...
        updatePaginationNumbers: function() {
            const currentEl = document.querySelector('.web-projects-swiper .swiper-pagination-current');
            const totalEl = document.querySelector('.web-projects-swiper .swiper-pagination-total');
