/**
 * mobile-projects.js - Mobile Projects Management
 * Handles mobile projects navigation, swiper initialization, and project display
 */
...
const MobileProjectsManager = {
    ...
    cacheElements: function() {
        ...
        this.elements.closeBtn = document.getElementById('mobile-swiper-close-btn');
    },
    ...
    setupNavigation: function() {
        ...
        console.log('Mobile projects navigation setup complete');
    },
    ...
    getProjectsByCategory: function(category) {
        // Projects are loaded from js/data/mobile-projects.js
    ...
    initMainSwiper: function() {
        ...
        console.log('Mobile projects swiper initialized');
    },
    ...
    closeSwiper: function() {
        if (this.elements.swiperContainer) {
            ...
            console.log('Mobile projects swiper closed');
        }
    },
...
// Initialize mobile projects when DOM is loaded
document.addEventListener('DOMContentLoaded', function() {
    MobileProjectsManager.init();
});

// Setup mobile apps navigation (called from main.js)
function setupMobileAppsNavigation() {
    // This function is called from main.js
    console.log('Mobile apps navigation setup complete');
}

// Export for use in other modules
if (typeof module !== 'undefined' && module.exports) {
    module.exports = {
        MobileProjectsManager,
